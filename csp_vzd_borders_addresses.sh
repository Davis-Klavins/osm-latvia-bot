...
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_ciems (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_ciems.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_ciems_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_ciems_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_ciems_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_dziv RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_dziv (kods, tips_cd, statuss, apstipr, apst_pak, vkur_cd, vkur_tips, nosaukums, sort_nos, atrib, dat_sak, dat_mod, dat_beig, std) FROM aw_dziv.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_dziv_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_dziv_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_dziv_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_eka RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_eka (kods, tips_cd, statuss, apstipr, apst_pak, vkur_cd, vkur_tips, nosaukums, sort_nos, atrib, pnod_cd, dat_sak, dat_mod, dat_beig, for_build, plan_adr, std, koord_x, koord_y, dd_n, dd_e) FROM aw_eka.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_eka_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_eka_his (kods, kods_his, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_eka_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_iela RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_iela (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_iela.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_iela_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_iela_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_iela_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_novads RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_novads (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_novads.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_novads_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_novads_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_novads_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_pagasts RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_pagasts (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_pagasts.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_pagasts_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_pagasts_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_pagasts_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_pilseta RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_pilseta (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib, std) FROM aw_pilseta.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_pilseta_his RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_pilseta_his (kods, tips_cd, dat_sak, dat_mod, dat_beig, std, nosaukums, vkur_cd, vkur_tips) FROM aw_pilseta_his.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_ppils RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_ppils (kods, ppils) FROM aw_ppils.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_rajons RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_rajons (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, apstipr, apst_pak, statuss, sort_nos, dat_sak, dat_mod, dat_beig, atrib) FROM aw_rajons.csv WITH (FORMAT CSV, HEADER)"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "TRUNCATE TABLE vzd.aw_vietu_centroidi RESTART IDENTITY;"
psql -h $IP_ADDRESS -p $PORT -U osm -d osm -w -c "\COPY vzd.aw_vietu_centroidi (kods, tips_cd, nosaukums, vkur_cd, vkur_tips, std, koord_x, koord_y, dd_n, dd_e) FROM aw_vietu_centroidi.csv WITH (FORMAT CSV, HEADER)"
